...
RIPPLE_DATA_DIR="${RIPPLE_DATA_DIR:-$RIPPLE_HOME_DIR/data}"
...
RIPPLE_DEFAULT_DB_PATH="${RIPPLE_DB_PATH:-$RIPPLE_DATA_DIR/ripple.db}"
RIPPLE_DEFAULT_OUTPUT_DIR="${RIPPLE_OUTPUT_DIR:-$RIPPLE_DATA_DIR/ripple_outputs}"
OPENCLAW_SKILL_NAME="ripple"
...
export RIPPLE_REPO_DIR="\${RIPPLE_REPO_DIR:-${RIPPLE_REPO_DIR}}"
export RIPPLE_DATA_DIR="\${RIPPLE_DATA_DIR:-${RIPPLE_DATA_DIR}}"
export RIPPLE_LLM_CONFIG_PATH="\${RIPPLE_LLM_CONFIG_PATH:-${RIPPLE_CONFIG_PATH}}"
export RIPPLE_DB_PATH="\${RIPPLE_DB_PATH:-${RIPPLE_DEFAULT_DB_PATH}}"
export RIPPLE_OUTPUT_DIR="\${RIPPLE_OUTPUT_DIR:-${RIPPLE_DEFAULT_OUTPUT_DIR}}"
